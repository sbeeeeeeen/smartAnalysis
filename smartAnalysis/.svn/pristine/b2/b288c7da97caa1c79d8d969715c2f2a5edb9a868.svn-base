...
mapOption = { 
    center: latlng = new daum.maps.LatLng(36.3250417, 127.4179621), // 지도의 중심좌표
    level: 3 // 지도의 확대 레벨
};
...
if("${analysisRec}"!=""){
	latlng = new daum.maps.LatLng("${analysisRec.AN_COORY}", "${analysisRec.AN_COORX}");
	marker = new daum.maps.Marker({ 
	    position: new daum.maps.LatLng("${analysisRec.AN_COORY}", "${analysisRec.AN_COORX}")
	}); 
