      ...
      <div class="panel panel-default">
         ...
         <div class="panel-body">
            ...
            <div class="col-lg-4 inputWithIcon">
                <input
                  type="text" placeholder="예) 창업" id="input_keyword">
...
<script>
   ...
   function callAjax() {
      ...
      if ($("input:checkbox[name=checktg]:checked").val() != null) {
         ...
         swal("타겟을 선택해 주세요.", "전체, 뉴스, 블로그 중 선택해주세요.");
      }
      ...
      if ($("#input_keyword").val() != "") {
         ...
         swal("키워드를 입력해 주세요.", "ex) 창업, 소상공인, 백종원 등...");
      }
      var string = "";
      if ($("#datefromto").val() != "") {
         string = $("#datefromto").val();
      } else {
         swal("날짜를 선택해 주세요.", "ex) 10/1 ~ 10/18");
      }
               ...
               success : function(data) {
                  ...
                  for (var j = 0; j < 3; j++) {
                     if(data.return_object.trends[j] !== undefined){
                        rankTableTtl+='<th>순위</th><th>검색어</th>';
                     }else{
                        break;
                     }
