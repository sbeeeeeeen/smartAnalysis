...
public interface ConsultingServiceInf {
	/**
	...
	*/
	Map<String, Object> consultingPageList(Map<String, Object> map);
	...
	*/
	Map<String, Object> consultingMemberPageList(Map<String, Object> map);
