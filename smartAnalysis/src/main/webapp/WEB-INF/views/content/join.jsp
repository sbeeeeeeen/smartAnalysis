				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<c:if test="${mem_name != null }">
							<input class="form-control" id="mem_name" name="mem_name" type="text" value="${mem_name }" readonly="readonly">
						</c:if>
						<c:if test="${mem_name == null }">
					...
					<div class="col-sm-6">
					    <div class="input-group">
					    	<c:if test="${mem_id != null }">
					    		<input class="form-control" id="mem_id" name="mem_id" type="text" value="${mem_id }" readonly="readonly">
					    		<p class="help-block" id="idcheckMsg">카카오톡 계정으로 회원가입시 아이디는 자동생성됩니다</p>
					    	</c:if>
					    	<c:if test="${mem_id == null }">
					    		<div class="input-group">
